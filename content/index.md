...
I’m a first-year computer science PhD student in the [Sampa group][sampa] at the [University of Washington][uw], advised by [Luis Ceze][luisceze], [Dan Grossman][djg], and [Emina Torlak][emina]. I’m interested in how programming languages will evolve in an era where hardware is unreliable, abstractions are rigid and outdated, and energy efficiency is critical. I’m supported by the [David Notkin Endowed Graduate Fellowship][notkin].
